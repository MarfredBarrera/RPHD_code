...
def connect_serial(port):
    try:
        ser = serial.Serial(port, 115200, timeout=0.1) #Baud Rate 115200
...
def send_command(ser, cmd, delay=0.0083): #This changes based on number of frames or how fast you want Stewart Platform to move
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python stewart_displacement.py [PORT] [MODE]")
        sys.exit(1)
