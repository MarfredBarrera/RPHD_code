...
def record_data(data, filename="ascii_data.csv"):
    ...
    # Open the file in append mode and write the elapsed time and data
...
if __name__ == '__main__':
    ...
    if options.mode == 'test':
        ...
        daq = Sensor('COM3', mode='ascii')  # for linux probably /dev/ttyUSB0, use dmesg | grep tty to find the port
        start_time = time.time()
